...
Tạo Project trên Colab dùng Spark đọc vào một file văn bản và đếm số từ trên bản, lọc ra k từ có tần suất xuất hiện nhiều nhất. [download](https://ngominhtoan.github.io/colab_massive_data/week1/ex2.ipynb), [link](https://github.com/NgoMinhToan/colab_massive_data/blob/main/week1/ex2.ipynb)
